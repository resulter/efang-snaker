 ...
 */
package com.efangtec.workflow.engine;

import com.efangtec.workflow.engine.cfg.Configuration;
...
public interface SnakerEngine {
	 ...
	 */
	public com.efangtec.workflow.engine.IProcessService process();
	
	/**
	 * 获取查询服务
	 * @return IQueryService 常用查询服务
	 */
	public com.efangtec.workflow.engine.IQueryService query();
	
	/**
	 * 获取实例服务
	 * @return IQueryService 流程实例服务
	 */
	public com.efangtec.workflow.engine.IOrderService order();
	
	/**
	 * 获取任务服务
	 * @return ITaskService 任务服务
	 */
	public com.efangtec.workflow.engine.ITaskService task();
	
	/**
	 * 获取管理服务
	 * @return IManagerService 管理服务
	 */
	public com.efangtec.workflow.engine.IManagerService manager();
