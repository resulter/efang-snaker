...
import com.efangtec.workflow.engine.Completion;
import com.efangtec.workflow.engine.IOrderService;
...
public class OrderService extends AccessService implements IOrderService {
	/**
	 * 创建活动实例
	 * @see com.efangtec.workflow.engine.core.OrderService#createOrder(Process, String, Map, String, String)
	 */
	...
	public Order createOrder(Process process, String operator, Map<String, Object> args,
		...
		order.setCreatorName((String)args.get("creator_name"));
	...
	/**
	 * 强制中止流程实例
	 * @see com.efangtec.workflow.engine.core.OrderService#terminate(String, String)
	 */
