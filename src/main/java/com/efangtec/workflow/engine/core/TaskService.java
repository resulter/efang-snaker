...
import com.efangtec.workflow.engine.*;
...
import com.efangtec.workflow.engine.helper.JsonHelper;
import com.efangtec.workflow.engine.helper.StringHelper;
import com.efangtec.workflow.engine.impl.GeneralAccessStrategy;
import com.efangtec.workflow.engine.model.CustomModel;
...
import com.efangtec.workflow.engine.model.TaskModel.PerformType;
import com.efangtec.workflow.engine.model.TaskModel.TaskType;
...
public class TaskService extends AccessService implements ITaskService {
	 ...
	 * @see SnakerEngineImpl#executeTask(String, String, Map)
	 */
	...
	public List<Task> createTask(TaskModel taskModel, Execution execution) {
        ...
        task.setVariable(JsonHelper.toJson(args));
		task.setOperator(execution.getOperator());
