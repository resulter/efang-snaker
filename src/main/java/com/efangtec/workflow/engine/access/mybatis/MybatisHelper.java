 ...
 *
 */
package com.efangtec.workflow.engine.access.mybatis;

import com.efangtec.workflow.engine.access.jdbc.JdbcHelper;
import com.efangtec.workflow.engine.access.transaction.TransactionObjectHolder;
...
public abstract class MybatisHelper {
	...
	private static final String SCAN_PACKAGE = "com.efangtec.workflow.engine.entity";
