...
import com.efangtec.workflow.engine.AssignmentHandler;
import com.efangtec.workflow.engine.core.Execution;
import com.efangtec.workflow.engine.handlers.impl.MergeActorHandler;
...
/**
 * 任务定义task元素
 * @author yuqscom.efangtec.workflow
 * @since 1.0
 */
public class TaskModel extends com.efangtec.workflow.engine.model.WorkModel {
	/**
	 * 
	 */
     ...
     * 字段模型集合
     */
    private List<com.efangtec.workflow.engine.model.FieldModel> fields = null;
    ...
    public List<com.efangtec.workflow.engine.model.FieldModel> getFields() {
        return fields;
    }

    public void setFields(List<com.efangtec.workflow.engine.model.FieldModel> fields) {
        this.fields = fields;
    }
