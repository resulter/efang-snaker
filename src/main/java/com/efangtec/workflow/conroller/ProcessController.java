...
import com.efangtec.workflow.SnakerHelper;
...
public class ProcessController {
	...
	public String processStart(Model model, String processName) {
		facets.startInstanceByName(processName, null, "username from shiroUtils", null);
		return "redirect:/snaker/process/list";
	}
	
	@RequestMapping(value = "static/json", method= RequestMethod.GET)
	@ResponseBody
